    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Missing_Marks', 'Missing marks'), ('Wrong_grading', 'wrong grading'), ('wrong_marks', 'wrong marks'), ('other', 'other')], default='other', max_length=100)),
                ...
                ('raised_by', models.ForeignKey(limit_choices_to={'role': 'student'}, on_delete=django.db.models.deletion.CASCADE, related_name='issues', to=settings.AUTH_USER_MODEL)),
                ('registrar', models.ForeignKey(limit_choices_to={'role': 'Registrar'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='registra_issues', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('computer_science', 'Computer Science Department'), ('networks', 'Networks Department'), ('information_systems', 'Information Systems')], max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ForeignKey(limit_choices_to={'role': 'Lecturer'}, on_delete=django.db.models.deletion.CASCADE, related_name='lecture_issues', to='api.user')),
                ('raised_by', models.ForeignKey(limit_choices_to={'role': 'student'}, on_delete=django.db.models.deletion.CASCADE, related_name='issues', to='api.user')),
            ],
        ),
    ]
